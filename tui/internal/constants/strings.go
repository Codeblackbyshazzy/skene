...
const (
	...
	DashboardSubtitle    = "Below you can see the results of your analysis."
	DashboardFilesHeader = "Skene context files"
	DashboardFilesDesc   = "These files are generated by the Skene growth package. You can regenerate any of these files by rerunning the commands in 'next steps.'"
...
const (
	FileDescManifest       = "Growth manifest with detected features, tech stack, and opportunities."
	FileDescTemplate       = "Structured growth template with strategies and recommendations."
